...
const TimerView = ({ 
  ...
  // Se não houver orações carregadas ainda
  if (!prayers || prayers.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-[#FF4DAD]">
        ...
        <p className="font-bold uppercase text-[10px] tracking-widest animate-pulse">Carregando Clamor...</p>
      </div>
    );
  }
    ...
    <div className="flex flex-col items-center gap-6 animate-fadeIn pb-20">
      ...
      <div className="w-44 h-44 rounded-full border-[6px] border-[#FF4DAD]/10 flex items-center justify-center bg-white shadow-inner">
        <div className="text-center">
          ...
          <span className="text-[9px] font-black text-[#FF4DAD] uppercase tracking-[0.2em]">
      ...
      <div className="w-full bg-white rounded-[2.5rem] p-8 shadow-2xl border border-purple-50">
        ...
        {/* VERSÍCULO - NOMES EXATOS DO FIREBASE */}
        ...
        <button
          ...
          className={`w-full py-4 rounded-2xl font-black uppercase text-[11px] tracking-widest transition-all ${
            prayerNote.trim() ? 'bg-[#FF4DAD] text-white shadow-lg' : 'bg-gray-100 text-gray-400'
          }`}
        >
